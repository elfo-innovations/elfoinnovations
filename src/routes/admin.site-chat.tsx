      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Every conversation visitors have with the website chatbot. Elsa's FAQ answers are
            managed separately.
          </p>
        </div>
                ...
                {thread.map((m) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div
                        className={`mt-0.5 text-[10px] text-muted-foreground ${m.role === "user" ? "text-right" : ""}`}
                      >
