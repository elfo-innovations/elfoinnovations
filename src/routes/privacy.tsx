    ...
    <PublicLayout>
      <section className="px-4 pb-20 pt-12 sm:pt-16">
        ...
        <div className="prose prose-neutral mx-auto max-w-3xl dark:prose-invert [&_a]:text-primary [&_a]:underline [&_h2]:mt-10 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-bold [&_h2]:tracking-tight [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mt-4 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-6">
          <p>
            This Privacy Policy explains how ELFO Innovations (&ldquo;ELFO,&rdquo;
            &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) collects, uses, stores, and
            protects information when you visit our website or submit information through it. By
          ...
          <ul>
            ...
            <li>
              <strong>Developer applications:</strong> your name, email address, phone number,
              the role you're applying for, your current employment status, a GitHub URL and,
              optionally, a portfolio URL, a short statement of motivation, and a resume file
              (PDF) that you upload.
            </li>
          </ul>
          <p>
            We do not require you to submit information beyond what a given form asks for, and we
            do not knowingly collect more than what is needed to respond to your inquiry or
            application.
          </p>
          ...
          <ul>
            ...
            <li>
              Detect and prevent duplicate, fraudulent, or abusive submissions to our forms.
            </li>
          </ul>
          <p>
          ...
          <p>
            Information submitted through our forms is stored in our database and, for resumes,
            in private file storage. Access to this data is restricted to authorized ELFO team
            members who need it to respond to inquiries or review applications; resume files in
            particular are not accessible through the browser and can only be written or read
            through server-side, authenticated processes. We take reasonable technical and
            organizational measures to protect the information we hold, including verifying that
            form submissions come from a real visitor (rather than automated abuse) before they
            are stored. That said, no method of electronic storage or transmission is completely
          ...
          <ul>
            <li>
              <strong>Hosting and infrastructure:</strong> our website is hosted and served
              through Cloudflare's platform.
            </li>
            <li>
            ...
            <li>
              <strong>Bot and spam prevention:</strong> our contact and developer-application
              forms use Cloudflare Turnstile to verify submissions are coming from a real visitor
            ...
            <li>
              <strong>Email delivery:</strong> transactional emails (for example, confirming
              receipt of a developer application) are sent through an email delivery provider.
            </li>
          </ul>
          <p>
            These providers process information only to the extent necessary to provide their
            respective service to us, and are subject to their own privacy practices and terms.
            We do not control, and are not responsible for, the privacy practices of third-party
          ...
          <p>
            ...
            translation feature described above. We do not currently use third-party advertising
            or tracking cookies. If this changes in the future, we will update this Policy
            accordingly.
          </p>

          <h2>6. Data Retention</h2>
          <p>
            We retain information submitted through our forms for as long as reasonably necessary
            to fulfil the purpose it was collected for — for example, to respond to an inquiry,
            evaluate an application, or maintain a record of an engagement — and as needed to
            comply with our legal or operational obligations. When information is no longer
            needed for these purposes, we take reasonable steps to delete or anonymize it.
          </p>

          <h2>7. Your Rights &amp; Requests</h2>
          <p>
            You may ask us to access, correct, or delete the personal information you have
            submitted to us, or ask us to stop using it for a particular purpose. To make such a
            request, please contact us using the details below. We will respond to legitimate
            requests within a reasonable timeframe, and may need to verify your identity before
            acting on a request. Depending on your location, you may also have additional rights
          ...
          <p>
            ...
            practices, the services we use, or legal requirements. When we do, we will update the
