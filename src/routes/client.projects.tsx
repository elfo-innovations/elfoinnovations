...
function ClientProjects() {
  ...
  const submit = async () => {
    ...
    if (!form.name.trim() || !form.requirements.trim())
      return toast.error("Project name and requirements are required");
    setBusy(true);
    try {
    ...
    <DashboardShell role="client">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Submit new requirements and track progress across the 4 stages.
          </p>
        </div>
        ...
        {(data ?? []).map((p: any) => {
          ...
          return (
            <Link
              ...
              params={{ id: p.id }}
              className="glass-card block rounded-2xl p-5 transition hover:border-primary"
            >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Submit project requirement</DialogTitle>
          </DialogHeader>
          <div className="grid gap-4">
            ...
            <div className="grid gap-1.5">
              ...
              <Textarea
                ...
                placeholder="Describe what you need. Features, pages, integrations, timeline, references…"
              />
            </div>
            ...
            <div className="grid gap-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                Select the services you'd like — an invoice will be generated automatically for
                these.
              </p>
