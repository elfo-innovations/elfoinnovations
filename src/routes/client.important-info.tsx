  ...
  return (
    <DashboardShell role="client">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Everything you need in one place — bills, database access, and key documents.
      </p>
      ...
      <div className="mt-6 grid gap-4">
        ...
        >
          {activeProject ? (
            ...
            <p className="text-sm text-muted-foreground">
              Your account manager will populate this shortly.
            </p>
          )}
        </Section>
        ...
        >
          {activeProject?.internal_notes ? (
            ...
            <p className="text-sm text-muted-foreground">
              Access details will appear here once your environment is provisioned.
            </p>
          )}
        </Section>
        ...
        <Section
          icon={Receipt}
          title="Payment bills"
          subtitle="Full history of invoices you've submitted"
        >
          {(invoices ?? []).length === 0 ? (
        ...
        <Section
          ...
          subtitle="Signed agreements and key documents from your admin"
        >
          {contracts.length === 0 ? (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">
                        {f.projects?.project_code} · {new Date(f.created_at).toLocaleDateString()}
                      </div>
                    </div>
